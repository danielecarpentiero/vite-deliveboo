...
<template>
    ...
    <div class="container">
      ...
      <section class="customer-logos slider mb-5">
        ...
        <div class="slide">
          <img
            decoding="async"
            src="https://www.galleriaborromea.it/wp-content/uploads/2022/09/billy_tacos_logo.png"
          />
        </div>
        <div class="slide">
          <img
            decoding="async"
            src="https://rhocenter.com/wp-content/uploads/2019/01/la-piadineria.png"
          />
        </div>
        <div class="slide">
          <img
  ...
  <div class="container mb-5">
    ...
    <ul class="row list-unstyled">
      ...
      >
        ...
        >
          <div
            class="card card-restaurant d-flex flex-column align-items-center border-0"
          >
  ...
  <div class="custom-shape-divider-bottom-1710512821">
    <svg
      data-name="Layer 1"
      xmlns="http://www.w3.org/2000/svg"
  ...
  <div class="custom-shape-divider-top-1710512768 mb-5">
    <svg
      data-name="Layer 1"
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 1200 120"
...
.custom-shape-divider-bottom-1710512821 svg {
  position: relative;
  display: block;
  top: 10px;
...
.custom-shape-divider-bottom-1710512821 .shape-fill {
  fill: #386641;
}

.custom-shape-divider-top-1710512768 svg {
  position: relative;
  display: block;
  width: calc(157% + 1.3px);
  height: 157px;
...
.custom-shape-divider-top-1710512768 .shape-fill {
  fill: #386641;
}
</style>
